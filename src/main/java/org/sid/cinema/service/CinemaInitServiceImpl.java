...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initSeances() {
		 Stream.of("12:00","15:00","18:00","21:00","00:00").forEach(s->{
	...
	public void initFilms() {
		...
		Stream.of("Spider man","Vikings","New police story","Matrix","Street fighter","Derailed").forEach(titreFilm->{
			Film film=new Film();
	...
	public void initProjections() {
		double[] prices=new double[] {30,50,70,90,95,100};
